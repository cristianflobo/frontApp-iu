...
const GenerarQr = ({navigation}) => {
  ...
  const generate = () =>{
    setdataQr(`[{cuenta:${selectedCuenta}},{monto:${input}},{moneda:${selectedMoneda}}]`)
    ...
    <View style={styles.conteinerGenerarQr}>
      ...
      <View style={styles.textMonto}>
        ...
        <TouchableOpacity
          ...
          // onPress={()=> loginUser()}
          onPress={()=> generate()}
          ><Text style={styles.testoBoton}>{ !generarFinish?"Generar QR":"Cerrar"}</Text>
        </TouchableOpacity>
